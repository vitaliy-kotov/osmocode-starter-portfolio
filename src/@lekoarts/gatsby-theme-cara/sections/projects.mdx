...
<ProjectCard
  title="Управление проектами по стандарту PRINCE2"
  link="https://www.axelos.com/certifications/propath/prince2-project-management?utm_source=cara&utm_medium=Theme"
  bg="linear-gradient(to right, #D4145A 0%, #FBB03B 100%)"
>
  Cтруктурированный метод управления проектами от авторов ITIL. Сертифицированные по междунароному стандарту Руководители Проектов.
</ProjectCard>
<ProjectCard
